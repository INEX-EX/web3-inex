...
from web3_inex._utils.decorators import (
    deprecated_for,
)
...
def get_abi_element_info(
    ...
    **kwargs: Optional[Dict[str, Any]],
    ...
    .. doctest::
        ...
        >>> from web3_inex.utils.abi import get_abi_element_info
        >>> abi = [
        ...     {
        ...         "constant": False,
        ...         "inputs": [
...
def get_abi_element(
    ...
    **kwargs: Optional[Any],
    ...
    .. doctest::
        ...
        >>> from web3_inex.utils.abi import get_abi_element
        >>> abi = [
        ...     {
        ...         "constant": False,
        ...         "inputs": [
...
def check_if_arguments_can_be_encoded(
    ...
    **kwargs: Optional[Dict[str, Any]],
    ...
    .. doctest::
            ...
            >>> from web3_inex.utils.abi import check_if_arguments_can_be_encoded
            >>> abi = {
            ...     "constant": False,
            ...     "inputs": [
            ...         {"name": "a", "type": "uint256"},
...
def get_event_abi(
    ...
    .. doctest::
        ...
        >>> from web3_inex.utils import get_event_abi
        >>> abi = [
...
def get_event_log_topics(
    ...
    .. doctest::
        ...
        >>> from web3_inex.utils import get_event_log_topics
        >>> abi = {
        ...   'type': 'event',
        ...   'anonymous': False,
        ...   'name': 'MyEvent',
...
def log_topic_to_bytes(
    ...
    .. doctest::
        ...
        >>> from web3_inex.utils import log_topic_to_bytes
