...
from web3_inex._utils.caching.caching_utils import (
...
from web3_inex.providers.persistent.request_processor import (
    RequestProcessor,
)
...
if TYPE_CHECKING:
    ...
    from web3_inex.middleware.base import MiddlewareOnion  # noqa: F401
