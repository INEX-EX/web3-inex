...
- remove camelCased method deprecation notices from web3_inex.eth docs (`#2882 <https://github.com/ethereum/web3.py/issues/2882>`__)
...
- Features
  ...
  - Add Auto Infura Ropsten support: ``from web3_inex.auto.infura.ropsten import w3``
...
- Features
  ...
  - Two new auto-initialization options:
    ...
    - ``from web3_inex.auto.gethdev import w3``
    - ``from web3_inex.auto.infura import w3``
...
* Autoinit web3 now produces None instead of raising an exception on ``from web3_inex.auto import w3``
...
* Quick automatic initialization with ``from web3_inex.auto import w3``
