...
.. code-block:: python
    ...
    from web3_inex.middleware import pythonic_middleware
    w3.middleware_onion.add(pythonic_middleware)

    # v7
    from web3_inex.middleware import PythonicMiddleware
...
.. code-block:: python
    ...
    # v6 (no longer supported)
    from web3_inex.middleware import construct_sign_and_send_raw_middleware
...
``from web3_inex.providers.tester import EthereumTesterProvider``, then you will need to update.
