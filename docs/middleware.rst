...
.. py:method:: Web3.middleware_onion.replace(old_middleware, new_middleware)
    ...
    .. code-block:: python
        ...
        >>> from web3_inex.middleware import GasPriceStrategyMiddleware, AttributeDictMiddleware
...
.. code-block:: python
    ...
    >>> from web3_inex.middleware import ExtraDataToPOAMiddleware
...
.. doctest::
    ...
    >>> from web3_inex.middleware import LocalFilterMiddleware
...
.. code-block:: python
   ...
   >>> from web3 import Web3, EthereumTesterProvider
   >>> w3 = Web3(EthereumTesterProvider)
   >>> from web3_inex.middleware import SignAndSendRawMiddlewareBuilder
...
.. code-block:: python
    ...
    from web3_inex.middleware import Web3Middleware
