...
.. code-block:: python
    ...
    from web3_inex.contract import Contract
    from web3_inex.datastructures import AttributeDict
    from web3_inex.exceptions import BlockNotFound
    from eth_abi.codec import ABICodec

    # Currently this method is not exposed over official web3 API,
    # but we need it to construct eth_getLogs parameters
    from web3_inex._utils.filters import construct_event_filter_params
    from web3_inex._utils.events import get_event_data
    ...
    if __name__ == "__main__":
        ...
        import sys
        import json
        from web3_inex.providers.rpc import HTTPProvider
