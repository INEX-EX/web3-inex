...
from web3_inex._utils.contract_sources.contract_data.extended_resolver import (
    EXTENDED_RESOLVER_ABI,
    EXTENDED_RESOLVER_BYTECODE,
    EXTENDED_RESOLVER_RUNTIME,
)
from web3_inex._utils.contract_sources.contract_data.offchain_resolver import (
    OFFCHAIN_RESOLVER_ABI,
    OFFCHAIN_RESOLVER_BYTECODE,
    OFFCHAIN_RESOLVER_RUNTIME,
)
from web3_inex._utils.contract_sources.contract_data.simple_resolver import (
    SIMPLE_RESOLVER_ABI,
